...
BOT_TOKEN = getenv("BOT_TOKEN", "1928719455:AAG3RV1KHJISY5dObSwq_6XNOIza5uXvYHg")
BOT_NAME = getenv("BOT_NAME", "Rem Music")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "Denger_inMusic")
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "mipanmusikita")
