...
import logging
from modules.msg import Messages as tr
from pyrogram import Client, filters
from pyrogram.types import InlineKeyboardMarkup, InlineKeyboardButton, Message
from config import SOURCE_CODE,ASSISTANT_NAME,PROJECT_NAME,SUPPORT_GROUP,UPDATES_CHANNEL,BOT_USERNAME
...
def _start(client, message):
    client.send_message(message.chat.id,
        ...
        reply_markup=InlineKeyboardMarkup([[
            ...
            InlineKeyboardButton("⚙️ Updates ⚙️", url=f"https://t.me/{UPDATES_CHANNEL}"), 
...
def map(pos):
    if(pos==1):
        ...
        button = [
            [InlineKeyboardButton("➕ Add me to Group ➕", url=f"https://t.me/{BOT_USERNAME}?startgroup=true")],
            [InlineKeyboardButton(text = '⚙️ Updates ⚙️', url=f"https://t.me/{UPDATES_CHANNEL}"),
